...
+ (NSArray<MusicItem *> *)createHardCodeData {
    ...
    MusicItem *model4 = [[MusicItem alloc] initWithSongName:@"Test big file" andArtist:@"The Weekend" downloadUrl:[[NSURL alloc] initWithString:@"http://ipv4.download.thinkbroadband.com/20MB.zip"]];
